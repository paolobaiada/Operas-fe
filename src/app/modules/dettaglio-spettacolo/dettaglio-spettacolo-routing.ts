...
export const routes: Routes = [
  {
    path: '',
    loadComponent: () => import('./components/dettaglio-spettacolo/dettaglio-spettacolo.component'), // Per utilizzare correttamente il lazy loading per il caricamento delle componenti ( Quindi utilizzando il loadComponent )
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import('./components/dettaglio-spettacolo-view/dettaglio-spettacolo-view.component'),
      },
    ],
  },
];